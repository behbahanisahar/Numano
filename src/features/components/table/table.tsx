...
const data = [
  {
    svg: <DKSVGIcon iconName="Cart3" color="green" />,
    name: "Top Authors",
    course: "ReactJs,HTML",
    Member: "4600 Users",
    size: "5.4MB",
  ...
  {
    svg: <DKSVGIcon iconName="blocks" color="orange" />,
  ...
  {
    svg: <DKSVGIcon iconName="Group" color="purple" />,
    name: "New Users",
    course: "Laravel, Metronic",
    Member: "890 Users",
    size: "1.5MB",
    key: "third",
  },
  {
    svg: <DKSVGIcon iconName="Library" color="yellow" />,
  ...
  {
    svg: <DKSVGIcon iconName="Box2" color="blue" />,
...
const TableSamira = (): ReactElement => {
  ...
  return (
    <>
      <span>{appContext?.state.userInfo.title}</span>
