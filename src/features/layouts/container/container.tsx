...
import ResponsiveAppBar from "src/features/components/app-bar/app-bar";
...
const Container = (): ReactElement => {
  ...
  return (
    <>
      <ResponsiveAppBar />
      <div
        className="container d-lg-flex justify-content-lg-center rtl flex-grow-1 h-100 py-lg-8 col-11"
        id="kt_wrapper"
      >
